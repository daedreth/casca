...
DESCRIPTION="The canary version of the all-in-one voice and text chat for gamers"
...
QA_PREBUILT="
	opt/discord/share/discordcanary/DiscordCanary
	opt/discord/share/discordcanary/libnode.so
	opt/discord/share/discordcanary/libffmpeg.so
"
